                ...
                <tbody>
                    <?php foreach ($allAnimals as $row) { 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="addanimals&animalId=<?php echo $row['id']; ?>"><img src="../../images/icons/edit.png" alt="" class="table_icon" title="Edit"></a>
<!-- archive -->
                                  <button  style="padding: 0;" type="button" id="deletebtn<?php echo $row['id']; ?>" class="deletebtn btn btn-edit" data-toggle="modal" >
                                    ...
                                    <div id="archivetooltip<?php echo $row['id']; ?>" class="tooltiptext">
                                        <p>Are you sure?</p>
                                        <a class="tip-arch" id="<?php echo $row['id']; ?>" href="manageanimals&archiveAnimalId=<?php echo $row['id']; ?>">Archive</a>
