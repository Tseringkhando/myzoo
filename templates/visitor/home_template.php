 <!-- ################################################################################################ -->
 <div class="wrapper bgded overlay" style="background-image:url('../images/zooimages/two-orange-and-blue-macaws-on-branch-1547836.jpg');">
        <div id="pageintro" class="hoc clear">
            <!-- ################################################################################################ -->
            <article>
                <p>Welcome to the Claybrook Zoo</p>
                <h3 class="heading">This is the current featured animal</h3>
                <p>Know more</p>
                <footer><a class="btn" href="#">Know more <i class="fas fa-angle-right"></i></a></footer>
            </article>
            <!-- ################################################################################################ -->
        </div>
    </div>
    ...
    <div class="wrapper row3">
        <main class="hoc container clear">
            ...
            <div class="sectiontitle">
                <h6 class="heading">Our zoo has various events</h6>
                <p>To keep up your spirits and ours</p>
            </div>
            <div class="group center btmspace-80">
                <article class="one_third first"><a class="ringcon btmspace-50" href="#"><i class="fas fa-calendar-alt"></i></a>
                ...
                <article class="one_third"><a class="ringcon btmspace-50" href="#"><i class=" fas fa-id-badge"></i></a>
                    <h6 class="heading">Tickets</h6>
    ...
    <div class="wrapper row2">
        <section class="hoc container clear">
            ...
            <article class="one_third first">
                ...
                <p>Sed placerat leo nec tincidunt aliquet ipsum mi ultrices magna eu tempor quam dolor eu sem nullam risus turpis rhoncus vel varius consequat laoreet ac neque pellentesque imperdiet sagittis velit vivamus urna ut dictum erat eu massa aliquam
                    nunc urna ornare.</p>
            ...
            <figure class="two_third">
                <a class="" href="#"><img src="../images/zooimages/zoomap.png" alt=""></a>
            </figure>
            <!-- <figure class="one_third">
                <a class="imgover" href="#"><img src="images/demo/348x420.png" alt=""></a>
            </figure> -->
            <!-- ################################################################################################ -->
        </section>
    </div>
    ...
    <div class="wrapper row3">
        <section class="hoc container clear">
            <!-- ################################################################################################ -->
            <div class="sectiontitle">
                <h6 class="heading">Do more online </h6>
                <p>......</p>
            </div>
            <ul class="nospace group btmspace-80 overview">
                <li class="one_third">
                    <article><a href="#"><i class="fas fa-smile"></i></a>
                        <h6 class="heading"><a href="#">Sponsor Log in</a></h6>
                        <p>Nunc quis mattis pede turpis at elit phasellus sed sem pellentesque nunc&hellip;</p>
                        <footer><a href="#">Log in <i class="fas fa-angle-right"></i></a></footer>
                    </article>
                </li>
                <li class="one_third">
                    <article><a href="#"><i class="fas fa-paw"></i></a>
                        <h6 class="heading"><a href="#">Animals to sponsor</a></h6>
                        <p>See the list of animals avalable for Sponsorship&hellip;</p>
    ...
    <div class="wrapper row2">
        <section class="hoc container clear">
            <!-- ################################################################################################ -->
            <div class="sectiontitle">
                <h6 class="heading">See our buddies</h6>
                <!-- <p>Dolor in fermentum ipsum vel mi mattis venenatis vivamus</p> -->
            </div>
            <div id="latest" class="group">
                <article class="one_third first">
                    <a class="imgover" href="#"><img style="height: 20em" src="images/zooimages/black-gorilla-in-close-up-photography-39571.jpg" alt=""></a>
                    <div class="excerpt">
                ...
                <article class="one_third">
                    <a class="imgover" href="#"><img style="height: 20em" src="images/zooimages/tiger-above-green-grass-during-day-time-46251.jpg" alt=""></a>
                    <div class="excerpt">
                ...
                <article class="one_third">
                    <a class="imgover" href="#"><img style="height: 20em" src="images/zooimages/animal-avian-beak-beautiful-409126.jpg" alt=""></a>
                    <div class="excerpt">
